...
export default {
    ...
    data() {
        ...
        return {
            todos: [
                new Todo('Something to do',localDate,localHour,'Task to be solved now'),
                new Todo('Something to be made',localDate,localHour,'Task to be solved later'),
                new Todo('Something was made',localDate,localHour,'Task to be solved at a later time')
...
button {
    ...
    height: 2em;
    border: 0;
    background-color: rgb(243, 167, 105)	;
    color: white;
    padding: 0.2em;
    border-radius: 50%;
    outline-style: none;
